      ...
      <main>
        ...
        <section style={{ position: "relative", padding: "8rem 0 6rem", overflow: "hidden", minHeight: "600px", display: "flex", alignItems: "center" }}>
          <div style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", zIndex: 0, backgroundColor: "#18181b" }}>
            <Image title="Slab leak detection Rita Ranch" src="/images/hero_home.jpg" alt="Slab leak technician serving Rita Ranch and Southeast Tucson" fill sizes="100vw" style={{ objectFit: "cover", opacity: 0.4 }} priority />
          </div>
        ...
        <section style={{ padding: "4rem 0", backgroundColor: "#f8fafc" }}>
          <div className="container">
            ...
            <div style={{ position: "relative", width: "100%", height: "300px", marginBottom: "2rem", borderRadius: "12px", overflow: "hidden", boxShadow: "0 4px 6px rgba(0,0,0,0.05)" }}>
              <Image src="/images/hero_home.jpg" alt="Residential slab leak service area in Rita Ranch and Southeast Tucson" fill sizes="(max-width: 768px) 100vw, 1200px" style={{ objectFit: "cover" }} />
            </div>
          ...
          <div className="container split-grid" style={{ alignItems: "center" }}>
            <div>
              ...
              <p style={{ fontSize: "1.05rem", color: "#4a4a4a", marginBottom: "1rem", lineHeight: "1.7" }}>
                Southeast Tucson includes planned residential communities, established neighborhoods, and properties near restricted or military areas. Service access and provider coverage can differ by address. ZIP codes 85707 and 85708 require additional confirmation because they may include Davis-Monthan Air Force Base, institutional, or controlled-access properties.
              </p>
              <p style={{ fontSize: "1.05rem", color: "#4a4a4a", marginBottom: "1rem", lineHeight: "1.7" }}>
                You might notice a <a href="/hot-water-slab-leak-tucson/" style={{ color: "var(--brand-red)", textDecoration: "underline", fontWeight: "600" }}>warm floor</a> near a bathroom while the water heater runs more frequently. You might also find that the water meter moves after irrigation and toilets have been ruled out. A qualified <strong>slab leak plumber Rita Ranch</strong> will isolate the hot system, perform a pressure test, and use acoustic or electronic tools to narrow the affected line before an <strong><a href="/under-slab-pipe-repair-tucson/" style={{ color: "var(--brand-red)", textDecoration: "underline", fontWeight: "600" }}>under-slab pipe repair</a> 85730</strong> is planned.
              </p>
              <p style={{ fontSize: "1.05rem", color: "#4a4a4a", marginBottom: "1rem", lineHeight: "1.7" }}>
                Whether you need a full <strong>slab leak service for Civano and Old Spanish Trail neighborhoods</strong> or <strong>water leak detection 85747</strong>, thorough diagnostics are always required.
              </p>
            </div>
            <div>
        ...
        <section style={{ padding: "5rem 0", backgroundColor: "#f8fafc" }}>
          <div className="container">
            ...
            <div style={{ position: "relative", width: "100%", height: "400px", marginBottom: "3rem", borderRadius: "12px", overflow: "hidden", boxShadow: "0 10px 30px rgba(0,0,0,0.1)" }}>
              <Image src="/images/electronic_leak_detection.jpg" alt="Plumbing technician performing electronic leak detection in Rita Ranch and Southeast Tucson" fill sizes="(max-width: 768px) 100vw, 1200px" style={{ objectFit: "cover" }} />
            </div>
        ...
        <section id="contact" style={{ backgroundColor: "#18181b", color: "var(--white)", padding: "5rem 0", textAlign: "center" }}>
          <div className="container" style={{ maxWidth: "800px" }}>
            <div style={{ position: "relative", width: "100%", height: "300px", marginBottom: "2rem", borderRadius: "12px", overflow: "hidden" }}>
              <Image src="/images/hero_emergency_leak.jpg" alt="Requesting slab leak service at a Rita Ranch and Southeast Tucson property" fill sizes="(max-width: 768px) 100vw, 800px" style={{ objectFit: "cover" }} />
            </div>
