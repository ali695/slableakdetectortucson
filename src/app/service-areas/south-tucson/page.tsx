...
export const metadata: Metadata = {
  title: 'Slab Leak Detection South Tucson, AZ',
  description: 'Request hidden water-line detection, under-slab pipe repair and urgent leak assistance across South Tucson, Sunnyside and nearby communities.',
  openGraph: {
    title: 'Slab Leak Detection South Tucson, AZ',
    description: 'Request hidden water-line detection, under-slab pipe repair and urgent leak assistance across South Tucson, Sunnyside and nearby communities.',
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Which South Tucson areas are covered on this page?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The page targets South Tucson, Sunnyside, Midvale Park, Pueblo Gardens, South Park, and nearby ZIP codes 85706, 85713, 85714, and 85756."
      }
    },
    {
      "@type": "Question",
      "name": "Can a rental property request slab leak service?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. The tenant, owner, or manager should clarify who can authorize testing and repair. Surface access and payment approval may require the property owner."
      }
    },
    {
      "@type": "Question",
      "name": "What if several units share one water meter?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The provider may need to isolate fixtures or building sections to identify where water loss is occurring. A shared meter can make diagnosis more complex."
      }
    },
    {
      "@type": "Question",
      "name": "Is water coming through the floor an emergency?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Active spreading water, rapid meter movement, or water near electricity should be treated urgently. Shut off the main supply if safe and request assistance."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "Why does ZIP code 85723 require confirmation?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "It includes institutional or special-use properties. The exact address and access requirements must be checked before a service provider can accept the request."
      }
    }
  ]
};
...
export default function SouthTucson() {
  return (
    <>
      <Header />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Slab Leak Detection South Tucson, AZ", "description": "Request hidden water-line detection, under-slab pipe repair and urgent leak assistance across South Tucson, Sunnyside and nearby communities.", "url": "https://tucsonslableakpros.com/service-areas/south-tucson/"}) }} />
      ...
      <main>
        ...
        <section style={{ position: "relative", padding: "8rem 0 6rem", overflow: "hidden", minHeight: "600px", display: "flex", alignItems: "center" }}>
          <div style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", zIndex: 0, backgroundColor: "#18181b" }}>
            <Image title="Slab leak detection South Tucson" src="/images/hero_home.jpg" alt="Slab leak technician serving South Tucson" fill sizes="100vw" style={{ objectFit: "cover", opacity: 0.4 }} priority />
          </div>
          ...
          <div className="container" style={{ position: "relative", zIndex: 10 }}>
            <div className="hero-grid">
              <div style={{ color: "var(--white)", paddingRight: "2rem" }}>
                ...
                <h1 style={{ color: "var(--white)", marginBottom: "1.5rem", fontSize: "3.5rem", lineHeight: "1.1", fontWeight: "800" }}>Slab Leak Detection and Repair in South Tucson</h1>
                <p style={{ fontSize: "1.1rem", marginBottom: "2rem", maxWidth: "600px", color: "#e4e4e7", lineHeight: "1.6" }}>
                  <a href="/slab-leak-detection-tucson/" style={{ color: "var(--brand-red)", textDecoration: "underline", fontWeight: "600" }}>Slab leak detection</a> and repair services can be requested across South Tucson, Sunnyside, Midvale Park, Pueblo Gardens, and nearby south-side communities. 
                </p>
                <p style={{ fontSize: "1.1rem", marginBottom: "2rem", maxWidth: "600px", color: "#e4e4e7", lineHeight: "1.6" }}>
                  The service begins by confirming whether the property is losing water through a pressurized plumbing line. Detection helps avoid opening concrete or flooring based only on a guess.
                </p>
              ...
              <div style={{ backgroundColor: "var(--white)", padding: "2.5rem", borderRadius: "8px", boxShadow: "0 20px 40px rgba(0,0,0,0.2)" }}>
                ...
                <div style={{ marginTop: "1.5rem", paddingTop: "1.5rem", borderTop: "1px solid #e2e8f0" }}>
                  <p style={{ margin: 0, fontSize: "0.9rem", color: "#64748b", textAlign: "center" }}>Main ZIP Codes: 85706, 85713, 85714, 85756 <br/>(Confirm 85723)</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section style={{ padding: "4rem 0", backgroundColor: "#f8fafc" }}>
          <div className="container">
            ...
            <div style={{ position: "relative", width: "100%", height: "300px", marginBottom: "2rem", borderRadius: "12px", overflow: "hidden", boxShadow: "0 4px 6px rgba(0,0,0,0.05)" }}>
              <Image src="/images/hero_home.jpg" alt="Residential slab leak service area in South Tucson" fill sizes="(max-width: 768px) 100vw, 1200px" style={{ objectFit: "cover" }} />
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: "1rem" }}>
              {['South Tucson', 'Sunnyside', 'Elvira', 'Midvale Park', 'Pueblo Gardens', 'South Park', 'Las Vistas', 'Mission Manor', 'Barrio Santa Rita', 'Western Hills', 'Littletown', 'Summit area'].map((area) => (
          ...
          <div className="container split-grid" style={{ alignItems: "center" }}>
            <div>
              ...
              <p style={{ fontSize: "1.05rem", color: "#4a4a4a", marginBottom: "1rem", lineHeight: "1.7" }}>
                South Tucson requests may involve detached homes, rentals, duplexes, small multifamily properties, and commercial-residential buildings. The water meter may serve one unit or more than one space, so a <strong>slab leak plumber 85714</strong> may need to identify which fixtures and lines belong to the affected property. 
              </p>
              <p style={{ fontSize: "1.05rem", color: "#4a4a4a", marginBottom: "1rem", lineHeight: "1.7" }}>
                An urgent call may involve water appearing at the edge of tile, sudden pressure loss, or rapid meter movement. A non-emergency request may involve a high bill with no visible damage. In both cases, the service provider should rule out toilets, irrigation, exterior lines, and appliances before planning an <strong><a href="/under-slab-pipe-repair-tucson/" style={{ color: "var(--brand-red)", textDecoration: "underline", fontWeight: "600" }}>under-slab pipe repair</a> 85706</strong>.
              </p>
              <p style={{ fontSize: "1.05rem", color: "#4a4a4a", marginBottom: "1rem", lineHeight: "1.7" }}>
                Whether you need a <strong>hidden water leak repair in Sunnyside</strong> or <strong>slab leak service in Midvale Park and Pueblo Gardens</strong>, our goal is to provide a fast and accurate diagnosis.
              </p>
            </div>
            <div>
              <div style={{ backgroundColor: "#18181b", padding: "3rem", borderRadius: "12px", color: "var(--white)", boxShadow: "0 20px 40px rgba(0,0,0,0.15)" }}>
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                  <li style={{ display: "flex", alignItems: "flex-start", gap: "1rem" }}>
                    ...
                    <div>
                      <strong>Warm or hot flooring:</strong> A leaking hot-water line may transfer heat through concrete or tile, although sunlight and ductwork can produce similar warmth.
                    </div>
                  </li>
                  <li style={{ display: "flex", alignItems: "flex-start", gap: "1rem" }}>
                    <span style={{ color: "var(--brand-red)", fontSize: "1.2rem", marginTop: "2px" }}>■</span>
                  ...
                  <li style={{ display: "flex", alignItems: "flex-start", gap: "1rem" }}>
                    <span style={{ color: "var(--brand-red)", fontSize: "1.2rem", marginTop: "2px" }}>■</span>
                    <div>
                      <strong>Damp flooring or baseboards:</strong> Moisture without an obvious source may come from an under-slab line, creating an emergency <strong>water coming through floor plumber 85714</strong> situation.
                    </div>
                  </li>
                  <li style={{ display: "flex", alignItems: "flex-start", gap: "1rem" }}>
                    <span style={{ color: "var(--brand-red)", fontSize: "1.2rem", marginTop: "2px" }}>■</span>
        ...
        <section style={{ padding: "5rem 0", backgroundColor: "#f8fafc" }}>
          <div className="container">
            ...
            <div style={{ position: "relative", width: "100%", height: "400px", marginBottom: "3rem", borderRadius: "12px", overflow: "hidden", boxShadow: "0 10px 30px rgba(0,0,0,0.1)" }}>
              <Image src="/images/electronic_leak_detection.jpg" alt="Plumbing technician performing electronic leak detection in South Tucson" fill sizes="(max-width: 768px) 100vw, 1200px" style={{ objectFit: "cover" }} />
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "2rem" }}>
              ...
              <div style={{ backgroundColor: "var(--white)", padding: "2rem", borderRadius: "8px", boxShadow: "0 4px 6px rgba(0,0,0,0.05)", borderTop: "4px solid var(--brand-red)" }}>
                ...
                <p style={{ color: "#4a4a4a", fontSize: "0.95rem", lineHeight: "1.6" }}>We check your water meter and perform <strong>water leak detection Sunnyside</strong> to determine whether a pressurized plumbing section is losing water.</p>
              </div>
              <div style={{ backgroundColor: "var(--white)", padding: "2rem", borderRadius: "8px", boxShadow: "0 4px 6px rgba(0,0,0,0.05)", borderTop: "4px solid var(--brand-red)" }}>
          ...
          <div className="container">
            <div className="split-grid" style={{ marginBottom: "5rem" }}>
              <div>
                ...
                <p style={{ fontSize: "1.05rem", color: "#4a4a4a", marginBottom: "1rem", lineHeight: "1.7" }}>
                  <strong>Planning the work:</strong> We ask you to provide access to the meter, shutoff, water heater, affected rooms, and any shared utility area. If a direct repair is chosen, we identify in the estimate concrete and flooring access. If a line is rerouted, we identify in the scope wall, ceiling, or exterior openings and restoration responsibilities.
                </p>
              </div>
            ...
            <div style={{ textAlign: "center", marginBottom: "3rem" }}>
              <h2 style={{ fontSize: "2.2rem", fontWeight: "800", color: "var(--dark-charcoal)" }}>Slab Leak Services Offered Across South Tucson</h2>
            </div>
        ...
        <section style={{ backgroundColor: "#f8fafc", padding: "5rem 0" }}>
          <div className="container">
            <h2 style={{ fontSize: "2.2rem", fontWeight: "800", color: "var(--dark-charcoal)", marginBottom: "3rem", textAlign: "center" }}>Slab Leak Questions from South Tucson Property Owners</h2>
            ...
            <div style={{ textAlign: "center", marginTop: "3rem" }}>
              <p style={{ color: "#64748b", marginBottom: "1rem" }}><strong>Related Areas:</strong> <Link href="/service-areas/central-tucson" style={{ color: "var(--brand-red)" }}>Central Tucson</Link> | <Link href="/service-areas/rita-ranch" style={{ color: "var(--brand-red)" }}>Rita Ranch & Southeast Tucson</Link></p>
            </div>
          </div>
        </section>
        ...
        <section id="contact" style={{ backgroundColor: "#18181b", color: "var(--white)", padding: "5rem 0", textAlign: "center" }}>
          <div className="container" style={{ maxWidth: "800px" }}>
            <div style={{ position: "relative", width: "100%", height: "300px", marginBottom: "2rem", borderRadius: "12px", overflow: "hidden" }}>
              <Image src="/images/hero_emergency_leak.jpg" alt="Requesting slab leak service at a South Tucson property" fill sizes="(max-width: 768px) 100vw, 800px" style={{ objectFit: "cover" }} />
            </div>
            <h2 style={{ fontSize: "2.5rem", fontWeight: "800", marginBottom: "1.5rem", color: "var(--white)" }}>Request Slab Leak Service in South Tucson</h2>
            ...
            <div style={{ backgroundColor: "var(--white)", padding: "3rem", borderRadius: "12px", textAlign: "left", color: "var(--dark-charcoal)", boxShadow: "0 20px 40px rgba(0,0,0,0.3)" }}>
              <h3 style={{ fontSize: "1.5rem", fontWeight: "800", marginBottom: "1.5rem", textAlign: "center" }}>Check South Tucson Availability Now</h3>
              <ZipCheckerForm />
            </div>
          </div>
        </section>
