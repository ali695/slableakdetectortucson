...
export const metadata: Metadata = {
  alternates: { canonical: "/service-areas/south-tucson/" },
  title: 'Slab Leak Detection South Tucson, AZ',
  description: 'Request hidden water-line detection, under-slab pipe repair leak assistance across South Tucson, Sunnyside and nearby communities.',
  openGraph: {
    title: 'Slab Leak Detection South Tucson, AZ',
    description: 'Request hidden water-line detection, under-slab pipe repair leak assistance across South Tucson, Sunnyside and nearby communities.',
    url: 'https://slableakdetectortucson.pages.dev/service-areas/south-tucson/',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Slab Leak Detection South Tucson, AZ",
      },
    ],
  },
  twitter: {
      ...
      <main>
        ...
        <section style={{ position: "relative", padding: "8rem 0 6rem", overflow: "hidden", minHeight: "600px", display: "flex", alignItems: "center" }}>
          <div style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", zIndex: 0, backgroundColor: "#18181b" }}>
            <Image title="Slab leak detection South Tucson" src="/images/south_tucson_hero.webp" alt="Slab leak technician serving South Tucson" fill sizes="100vw" style={{ objectFit: "cover", opacity: 0.4 }} priority />
          </div>
        ...
        <section style={{ padding: "4rem 0", backgroundColor: "#f8fafc" }}>
          <div className="container">
            ...
            <div style={{ position: "relative", width: "100%", height: "300px", marginBottom: "2rem", borderRadius: "12px", overflow: "hidden", boxShadow: "0 4px 6px rgba(0,0,0,0.05)" }}>
              <Image src="/images/south_tucson_hero.webp" alt="Residential slab leak service area in South Tucson" fill sizes="(max-width: 768px) 100vw, 1200px" style={{ objectFit: "cover" }} />
            </div>
        ...
        <section style={{ padding: "5rem 0", backgroundColor: "#f8fafc" }}>
          <div className="container">
            ...
            <div style={{ position: "relative", width: "100%", height: "400px", marginBottom: "3rem", borderRadius: "12px", overflow: "hidden", boxShadow: "0 10px 30px rgba(0,0,0,0.1)" }}>
              <Image src="/images/electronic_leak_detection.webp" alt="Plumbing technician performing electronic leak detection in South Tucson" fill sizes="(max-width: 768px) 100vw, 1200px" style={{ objectFit: "cover" }} />
            </div>
        ...
        <section id="contact" style={{ backgroundColor: "#18181b", color: "var(--white)", padding: "5rem 0", textAlign: "center" }}>
          <div className="container" style={{ maxWidth: "800px" }}>
            <div style={{ position: "relative", width: "100%", height: "300px", marginBottom: "2rem", borderRadius: "12px", overflow: "hidden" }}>
              <Image src="/images/hero_emergency_leak.webp" alt="Requesting slab leak service at a South Tucson property" fill sizes="(max-width: 768px) 100vw, 800px" style={{ objectFit: "cover" }} />
            </div>
