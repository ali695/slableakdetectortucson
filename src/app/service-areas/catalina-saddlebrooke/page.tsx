      ...
      <main>
        ...
        <section style={{ position: "relative", padding: "8rem 0 6rem", overflow: "hidden", minHeight: "600px", display: "flex", alignItems: "center" }}>
          <div style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", zIndex: 0, backgroundColor: "#18181b" }}>
            <Image title="Slab leak detection Catalina AZ" src="/images/hero_home.jpg" alt="Slab leak technician serving Catalina and SaddleBrooke" fill sizes="100vw" style={{ objectFit: "cover", opacity: 0.4 }} priority />
          </div>
        ...
        <section style={{ padding: "4rem 0", backgroundColor: "#f8fafc" }}>
          <div className="container">
            ...
            <div style={{ position: "relative", width: "100%", height: "300px", marginBottom: "2rem", borderRadius: "12px", overflow: "hidden", boxShadow: "0 4px 6px rgba(0,0,0,0.05)" }}>
              <Image src="/images/hero_home.jpg" alt="Residential slab leak service area in Catalina and SaddleBrooke" fill sizes="(max-width: 768px) 100vw, 1200px" style={{ objectFit: "cover" }} />
            </div>
          ...
          <div className="container split-grid" style={{ alignItems: "center" }}>
            <div>
              ...
              <p style={{ fontSize: "1.05rem", color: "#4a4a4a", marginBottom: "1rem", lineHeight: "1.7" }}>
                Properties in this northern service area may include planned communities, gated neighborhoods, detached homes, and foothill lots. Community access rules and homeowner-association requirements may affect parking, work hours, or surface repairs. The homeowner should confirm access instructions when requesting <strong><a href="/slab-leak-repair-tucson/" style={{ color: "var(--brand-red)", textDecoration: "underline", fontWeight: "600" }}>slab leak repair</a> in SaddleBrooke AZ</strong>.
              </p>
              <p style={{ fontSize: "1.05rem", color: "#4a4a4a", marginBottom: "1rem", lineHeight: "1.7" }}>
                A resident may notice a warm area near a bathroom or hear water moving when fixtures are closed. Another may receive a high-use notice without visible damage. A <strong>slab leak plumber Catalina</strong> may compare the meter, isolate hot and cold systems, test pressure, and then use locating equipment to narrow the likely pipe route.
              </p>
              <p style={{ fontSize: "1.05rem", color: "#4a4a4a", marginBottom: "1rem", lineHeight: "1.7" }}>
                Because these homes are often spread out on larger lots, <strong>hidden water leak testing in ZIP code 85739</strong> requires evaluating the lengthy private service lines alongside interior under-slab plumbing.
              </p>
            </div>
            <div>
